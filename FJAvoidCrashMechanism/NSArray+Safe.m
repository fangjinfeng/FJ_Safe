...
+ (void)load {
    ...
    dispatch_once(&onceToken, ^{
        ...
        [NSObject fjf_exchangeInstanceMethodWithSelfClass:NSClassFromString(@"__NSArray0")
                                         originalSelector:NSSelectorFromString(tmpStr)                                     swizzledSelector:NSSelectorFromString(tmpFirstStr)];
        
        [NSObject fjf_exchangeInstanceMethodWithSelfClass:NSClassFromString(@"__NSSingleObjectArrayI")
                                         originalSelector:NSSelectorFromString(tmpStr)                                     swizzledSelector:NSSelectorFromString(tmpSecondStr)];
        
        [NSObject fjf_exchangeInstanceMethodWithSelfClass:NSClassFromString(@"__NSArrayI")
        ...
        [NSObject fjf_exchangeInstanceMethodWithSelfClass:NSClassFromString(@"NSArray")
